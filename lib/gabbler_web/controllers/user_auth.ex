defmodule GabblerWeb.UserAuth do
  import Plug.Conn
  ...
  # Make the remember me cookie valid for 240 days.
  # If you want bump or reduce this value, also change
  # the token expiry itself in UserToken.
  @max_age 60 * 60 * 24 * 240
